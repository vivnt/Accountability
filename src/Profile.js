...
class Profile extends Component {
  ...
  render() {
    return (<Container text="text">
      ...
      <Form>
        <Form.Field required="required" control={Button} onClick={this.signOut}>Sign Out</Form.Field>
      </Form>

      <Form>
        <Form.Field required="required" control={Button} onClick={this.handleSubmit}>Submit</Form.Field>
      </Form>
    </Container>)
  }
}
